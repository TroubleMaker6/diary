...
from text_cnn_reuter import text_cnn_reuter_model
...
def main(_):
    ...
    train_x_ndarray, train_y_ndarray, valid_x_ndarray, valid_y_ndarray = \
        data_util_reuter.splitData(shuffle_data_ndarray, shuffle_class_ndarray, my_flag.valid_data_percentage)
    ...
    with tf.Graph().as_default():
        ...
        with session.as_default():
            # 定义模型
            model = text_cnn_reuter_model.TextCNN(sequence_size=my_flag.sentence_size,
